...
// Tokens: the upstream source of this component targets Intent UI, whose
// palette is named muted-fg / overlay / overlay-fg / fg. This project is
// shadcn, where the same roles are muted-foreground / popover /
// popover-foreground / foreground. The class names below are mapped to this
// project's vocabulary — Tailwind emits no utility for a token that does not
// exist, so leaving the originals in place would have rendered the tooltip
// and legend text with no colour at all.
//
// The dark variant here is `.dark &`, matching the @custom-variant in
// index.css. There is no `dark:` media query in this project.
