 ...
 *
 * The cards are focusable so the reveal is reachable by keyboard, but they do
 * not navigate anywhere. If you give them an action, swap the div for a button
 * or an anchor rather than adding a click handler to a div.
 */
      ...
      {items.map((item) => (
        <div
          ...
          className={cn(
            ...
            // The scale/blur transition is decorative; respect the OS setting.
