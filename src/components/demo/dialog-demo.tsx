...
function Component() {
  ...
  const handleScroll = () => {
    ...
    // Short terms that fit without scrolling give 0 here. The upstream version
    // divided by it, got NaN, and the "I agree" button stayed disabled with no
    // way to reach the bottom — there was no bottom to reach.
    if (scrollable <= 0) {
      setHasReadToBottom(true);
      return;
    }
    const scrollPercentage = content.scrollTop / scrollable;
